<?php
  ...
  */
  ...
  switch( SITE_COREDIR ){
    ...
    // Live
	  case "/var/www/intranet/core":
      define( "DB_HOST", "localhost" );
      define( "DB_NAME", "intranet" );
      define( "DB_USER", "intranet" );
      define( "DB_PASS", "iuhesfoih;es;io" );
      define( "SITE_ROOT", "/" );
      define( "SITE_PROTOCOL", "https" );
      define( "SITE_TYPE","PROD" );
      define( "LDAP_HOST", "directory.example.com" );
      define( "PROXY_HOST", "" );
      define( "PROXY_PORT", "" );
      define( "SITE_BACKUPDIR", "/media/backup/" );
      define( "SITE_ENABLEEXPORTQUEUE", true );
      
      define( "SITE_AUTH", "ldap" );
      
      // Paths
      define( "PHP_PATH", "/usr/bin/php" );
      define( "WKPDF_PATH", "/usr/bin/wkhtmltopdf-amd64" );
    ...
    // Test
    case "/var/www/test/core":
      define( "DB_HOST", "localhost" );
      define( "DB_NAME", "test" );
      define( "DB_USER", "test" );
      define( "DB_PASS", "yumyuasdeasf" );
      define( "SITE_ROOT", "/" );
      define( "SITE_PROTOCOL", "http" );
      define( "SITE_TYPE","TEST" );
      define( "LDAP_HOST", "directory.example.com" );
      define( "PROXY_HOST", "" );
      define( "PROXY_PORT", "" );
      define( "SITE_BACKUPDIR", "/media/backup/" );
  ...
  */
  switch( $_SERVER["SERVER_NAME"] ){
    ...
    default:
      define( "SITE_DEFAULTHOST", "intranet.example.com" );
      define( "SITE_DEFAULTBASE", "https://".SITE_DEFAULTHOST."/" );
